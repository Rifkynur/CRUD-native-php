...
<center class="mt-3">
    <a href="index.php" class="btn btn-primary ">Buku</a>
    <a href="penerbit/penerbit.php" class="btn btn-primary " >Penerbit</a>
    <a href="pengarang/pengarang.php" class="btn btn-primary ">Pengarang</a>
    <a href="katalog/katalog.php" class="btn btn-primary ">Katalog</a>
    <hr>
</center>
